...
resource "aws_iam_policy" "AWSLoadBalancerControllerIAMPolicy" {
  ...
  path        = "/"
  description = "Policy to enable EKS ALB"
  policy = <<EOF
{
    "Version": "2012-10-17",
    "Statement": [
...
# Associate alb-controller service account with IAM role
data "aws_iam_policy_document" "eks-alb-assume-role-policy" {
  statement {
...
resource "aws_iam_role" "AmazonEKSLoadBalancerControllerRole" {
  assume_role_policy = data.aws_iam_policy_document.eks-alb-assume-role-policy.json
  name               = "AmazonEKSLoadBalancerControllerRole"
}

# Attach permission policy with the role
resource "aws_iam_role_policy_attachment" "albcontroller-role-attach" {
